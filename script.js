...
const translations = {
  en: {
    ...
    'stats-top-language': 'Top language',
    'repos-eyebrow': 'Repository feed',
    'repos-title': 'Notable trending repositories',
    'repos-desc': 'Ranked from the visible GitHub Trending snapshot. Each card keeps the signal tight: language, total stars, forks, and new stars today.',
    'method-eyebrow': 'Snapshot method',
    'method-title': 'Static, transparent, and easy to update.',
    'footer-copy': 'Built as a static interface snapshot.',
    'language': 'Language',
  },
  vi: {
    ...
    'stats-top-language': 'Ngôn ngữ top',
    'repos-eyebrow': 'Danh sách repo',
    'repos-title': 'Repo trending nổi bật',
    'repos-desc': 'Xếp hạng từ snapshot GitHub Trending. Mỗi card gọn gàng: ngôn ngữ, tổng sao, fork, sao hôm nay.',
    'method-eyebrow': 'Snapshot method',
    'method-title': 'Tĩnh, minh bạch, dễ cập nhật.',
    'footer-copy': 'Snapshot tĩnh giao diện.',
    'language': 'Ngôn ngữ',
  },
};
